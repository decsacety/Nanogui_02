...
namespace nanogui {
    ...
    //// To keep the glad.h not in a all headerFile
    //// Initialize a uniform parameter with a 4x4 matrix (float)
    //template <typename T>
    //void GLShader::setUniform(const std::string& name, const Eigen::Matrix<T, 4, 4>& mat, bool warn) {
    ...
    //template <typename T>
    //void GLShader::setUniform(const std::string& name, const Eigen::Transform<T, 3, 3>& affine, bool warn) {
    ...
    //template <typename T>
    //void GLShader::setUniform(const std::string& name, const Eigen::Matrix<T, 3, 3>& mat, bool warn) {
    ...
    //template <typename T>
    //void GLShader::setUniform(const std::string& name, const Eigen::Transform<T, 2, 2>& affine, bool warn) {
    ...
    //void GLShader::setUniform(const std::string& name, bool value, bool warn ) {
    //    glUniform1i(uniform(name, warn), (int)value);
    //}

    ///// Initialize a uniform parameter with an integer value
    //template <typename T, typename std::enable_if<detail::type_traits<T>::integral == 1, int>::type>
    //void GLShader::setUniform(const std::string& name, T value, bool warn ) {
    //    glUniform1i(uniform(name, warn), (int)value);
    //}

    ///// Initialize a uniform parameter with a floating point value
    //template <typename T, typename std::enable_if<detail::type_traits<T>::integral == 0, int>::type>
    //void GLShader::setUniform(const std::string& name, T value, bool warn, int /*sign*/) {
    //    glUniform1f(uniform(name, warn), (float)value);
    //}

    ///// Initialize a uniform parameter with a 2D vector (int)
    //template <typename T, typename std::enable_if<detail::type_traits<T>::integral == 1, int>::type>
    //void GLShader::setUniform(const std::string& name, const Eigen::Matrix<T, 2, 1>& v, bool warn, int /*sign*/) {
    //    glUniform2i(uniform(name, warn), (int)v.x(), (int)v.y());
    //}

    ///// Initialize a uniform parameter with a 2D vector (float)
    //template <typename T, typename std::enable_if<detail::type_traits<T>::integral == 0, int>::type >
    //void GLShader::setUniform(const std::string& name, const Eigen::Matrix<T, 2, 1>& v, bool warn ) {
    //    glUniform2f(uniform(name, warn), (float)v.x(), (float)v.y());
    //}

    ///// Initialize a uniform parameter with a 3D vector (int)
    //template <typename T, typename std::enable_if<detail::type_traits<T>::integral == 1, int>::type >
    //void GLShader::setUniform(const std::string& name, const Eigen::Matrix<T, 3, 1>& v, bool warn ) {
    ...
    //template <typename T, typename std::enable_if<detail::type_traits<T>::integral == 1, int>::type >
    //void GLShader::setUniform(const std::string& name, const Eigen::Matrix<T, 4, 1>& v, bool warn ) {
